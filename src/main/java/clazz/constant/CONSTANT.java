...
public abstract class CONSTANT {
    ...
    public static CONSTANT parseConstant(int tag, ClassReader classReader) {
        return map.get(tag).parse(classReader);
    }
    ...
    static {
        ...
        map.put(constant_float_info.getValue(), constant_float_info);
        CONSTANT_Inter_info constant_inter_info = new CONSTANT_Inter_info();
        map.put(constant_inter_info.getValue(), constant_inter_info);
        CONSTANT_InterfaceMethodref_info constant_interfaceMethodref_info = new CONSTANT_InterfaceMethodref_info();
